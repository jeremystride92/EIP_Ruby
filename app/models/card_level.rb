class CardLevel < ActiveRecord::Base
  ...
  has_many :temp_benefits, as: :beneficiary, class_name: 'Benefit', conditions: '(start_date IS NOT NULL) OR (end_date IS NOT NULL)'
  ...
  accepts_nested_attributes_for :temp_benefits, allow_destroy: true, reject_if: proc { |attrs| attrs[:description].blank? }
